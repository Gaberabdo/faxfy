...
class ColorManager {
  ...
  static Color primaryColor = const Color.fromRGBO(37, 44, 89, 1.0);
  static Color secondColor = const Color.fromRGBO(242, 208, 39, 1);
  static Color thirdColor = const Color(0xFFE67E22);
